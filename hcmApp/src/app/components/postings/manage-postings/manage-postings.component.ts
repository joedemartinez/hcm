...
export class ManagePostingsComponent {
  ...
  getPostingDetails(){
    //posting
    this.httpService.get("http://localhost:8080/api/postings").subscribe((results: any) => {
  ...
  deletePosting(id:any){
    ...
    if(proceed){
      ...
      this.httpService.delete("http://localhost:8080/api/postings/delete/"+id).subscribe((results: any) => {
