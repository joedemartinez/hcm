...
export class PromotionsComponent {
  ...
  getPromotionDetails(){
    //promotions
    this.httpService.get("http://localhost:8080/api/promotions").subscribe((results: any) => {
  ...
  getPromotionHistory(){
    //promotions history
    this.httpService.get("http://localhost:8080/api/promtionsHistory").subscribe((results: any) => {
